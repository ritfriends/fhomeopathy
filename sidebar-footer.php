	...
	<div id="footer-cols-inner">
		...
		<div class="col3a">
			...
			<?php if ( !dynamic_sidebar( 'footer-column-1-widget-area' ) && current_user_can('edit_theme_options') ) : ?>
						...
						<h2 class="footer-title">
							<?php esc_html_e('Footer Col Widget 1', 'fhomeopathy'); ?>
						</h2><!-- .footer-title -->
						...
						<div class="textwidget">
							<?php esc_html_e('This is first footer widget area. To customize it, please navigate to Admin Panel -> Appearance -> Widgets and add widgets to Footer Column #1.', 'fhomeopathy'); ?>
						</div><!-- .textwidget -->
		...
		<div class="col3b">
			<?php if ( !dynamic_sidebar( 'footer-column-2-widget-area' ) && current_user_can('edit_theme_options') ) : ?>
					...
					<h2 class="footer-title">
						<?php esc_html_e('Footer Col Widget 2', 'fhomeopathy'); ?>
					</h2><!-- .footer-title -->
					...
					<div class="textwidget">
						<?php esc_html_e('This is second footer widget area. To customize it, please navigate to Admin Panel -> Appearance -> Widgets and add widgets to Footer Column #2.', 'fhomeopathy'); ?>
					</div><!-- .textwidget -->
		...
		<div class="col3c">
			<?php if ( !dynamic_sidebar( 'footer-column-3-widget-area' ) && current_user_can('edit_theme_options') ) : ?>
					...
					<h2 class="footer-title">
						<?php esc_html_e('Footer Col Widget 3', 'fhomeopathy'); ?>
					</h2><!-- .footer-title -->
					...
					<div class="textwidget">
						<?php esc_html_e('This is third footer widget area. To customize it, please navigate to Admin Panel -> Appearance -> Widgets and add widgets to Footer Column #3.', 'fhomeopathy'); ?>
					</div><!-- .textwidget -->
