	...
	<?php if (have_posts()) :
			...
			while (have_posts()) :
				...
				if ( comments_open() || get_comments_number() ) {
					...
					wp_link_pages( array(
						'before'      => '<div class="page-links"><span class="page-links-title">' . __( 'Pages:', 'fhomeopathy' ) . '</span>',
						'after'       => '</div>',
						'link_before' => '<span>',
						'link_after'  => '</span>',
					) );
					...
					the_post_navigation( array(
                        ...
                        'prev_text' => __( 'Previous Post: %title', 'fhomeopathy' ),
                        'next_text' => __( 'Next Post: %title', 'fhomeopathy' ),
                    ) );
